...
| 通常表示 | マウスオーバー時 |
| --- | --- |
| ![Pro プランのペットと3本のリング](docs/assets/pro-pet-rings-20260910.png) | ![Pro プランの残り枠：週次95%、Spark 週次100%、Spark 5時間100%、JST のリセット日時](docs/assets/pro-pet-hover-20260910.png) |

Pro プランの実画面（2026年9月10日撮影）。黒背景で撮影したスクリーンショットをそのまま掲載しています。ペットまたはリングにマウスを重ねると、各枠の**残り割合と JST のリセット日時**が表示されます。数値は撮影時点のものです。
